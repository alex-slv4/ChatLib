package controller {
	...
	public class ChatController extends EventDispatcher {
		...
		public function connect(credentials:LoginCredentials):void {
			...
			Security.loadPolicyFile("xmlsocket://" + ChatController.serverName + ":" + ChatController.serverPort);
			registerUser = false;
			connection.tls = ChatController.useTls;
			connection.username = username;
			connection.password = credentials.password;
			connection.domain = domain;
			connection.server = ChatController.serverName;
			connection.port = ChatController.serverPort;
			connection.connect();
		}
